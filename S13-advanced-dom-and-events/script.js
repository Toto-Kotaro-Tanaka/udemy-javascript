...
btnsOpenModal.forEach((btn) => btn.addEventListener("click", openModal)); // Use forEach instead of for loop
...
// ### Sticky Navigation ### - Not good practice as it triggers the event on scroll all the time
...
// Stop propagation
// e.stopPropagation(); // Usually not a good idea to use it
// });
